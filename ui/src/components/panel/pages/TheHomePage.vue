...
const previousSlide = () => {
  // @ts-expect-error
  if (
    ui[uiState.value].procedures[currentProcedure.value[uiState.value]].feature.currentSlide > 0
  ) {
    // @ts-expect-error
...
const nextSlide = () => {
  ...
  if (
    ui[uiState.value].procedures[currentProcedure.value[uiState.value]].feature.currentSlide <
    ui[uiState.value].procedures[currentProcedure.value[uiState.value]].feature.slides.length - 1
  ) {
    // @ts-expect-error
    ui[uiState.value].procedures[currentProcedure.value[uiState.value]].feature.currentSlide++;
  }
  ...
  <div class="home-page">
    ...
    <div class="procedures">
      <template v-for="(procedure, index) in ui[uiState].procedures" :key="procedure.name">
        <ProcedureComponent
          :current="index === currentProcedure[uiState]"
    ...
    <div class="feature">
      <component
        v-if="ui[uiState].procedures[currentProcedure[uiState]].feature.slides.length"
        :is="
          ui[uiState].procedures[currentProcedure[uiState]].feature.slides[
            ui[uiState].procedures[currentProcedure[uiState]].feature.currentSlide
          ].slide
        "
        v-bind="
          ui[uiState].procedures[currentProcedure[uiState]].feature.slides[
      ...
      >
        <div class="current-slide-container">
          ...
          <p class="slides-count">
            {{ ui[uiState].procedures[currentProcedure[uiState]].feature.slides.length }}
          </p>
        </div>
        ...
        <div class="slide-controls">
          ...
          <NButton
            ...
            v-if="
              ui[uiState].procedures[currentProcedure[uiState]].feature.currentSlide <
              ui[uiState].procedures[currentProcedure[uiState]].feature.slides.length - 1
            "
          >
            <svg
              width="16"
